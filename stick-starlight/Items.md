...
* **Starlight Steel**
  A piece of metal gifted starlight by t!he [[Structures#Player Made|Starlight Concentrator]]. Used in craft many of the [[Structures#Player Made|Structures]]. Crafted its self by placing metal (2x copper, 1x iron maybe) in the [[Structures#Player Made|Starlight Concentrator]]
  + I like the new name! "starmetal" was wizardly but lackluster

## Tools
* **Scrappy Ascended Staff**
  A basic Ascended Staff made with scraps and trash parts. Will surely break after only a few uses (crafted with [[stick-starlight/Items#Common Items|Aquamarine]], sticks, and obsidian (SUBJECT TO CHANGE))
  + the staff itself is not yet ascended, we could maybe call it "Scrappy Staff of the Ascent"
  + ooohoohoh this is making me want to use the word "Ascent" in a buncha stuff
  + the higher I rise the more I see, etc
* **Juvenile Tools**
  In the early ascent of Astral Arcana, tools will match the infantile abilities. All [[stick-starlight/Items#Tool Levels|Juvenile]] Astral Tools match an area between Iron and Diamond in all fields (but diamond mining level). Crafted with [[stick-starlight/Items#Common Items|Starlight Steel]]

## Armor
Armor is a bit more complicated; but, the overall idea is that armor does not get replaced, but evolves. Early armor (IE: [[stick-starlight/Items#Tool Levels|Juvenile]]) is just a cape that reduces

## Tool Levels
+ I like the names of these tiers but they could use more cohesion.
+ I'm iffy on the child (infantile/juvenile/mature) words, but we can make it work
+ I really like the words AS used like Iridescent
	- the light language is safest bet I think, but again I'm open to being adventurous
	- could diverge from AS words but stay on theme, e.g. Dim/Clouded, Twinkling/Shining/Pearlescent
+ Stickia Ultima reference
* Juvenile
	* The most basic tools
	* Requires only basic Minecraft materials, along with [[stick-starlight/Items#Common Items|Starlight Steel]] and [[stick-starlight/Items#Common Items|Aquamarine]]
		+ note that aquamarine (irl) is stronger than steel
	* No custom weapons or tools, just the basic: sword, pickaxe, axe, shovel, and hoe
	* About between iron and diamond
* Matured
	* More complex tools
	* Requires a mix of (NOT YET WRITTEN MATERIALS)
	* Beginning of custom tools:
		* Solar Hammer (Dnd style "war hammer" type weapon)
	...
	* Armor 
	* [[TODO|TODO: Finish the level]]
* Iridescent
	* Highest level of common tools
	* [[TODO|TODO: Finish the level]]
* Ultima
	* The most powerful tools in the mod
	* Little to no real Minecraft based tools, but custom powerful tools (both weapons and multi-tools):
		* King Ghidorah's Will
		* Laniakea's Might
			+ that's me!!
		* Aquarius's Quarry
