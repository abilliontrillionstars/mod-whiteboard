...
* Celeritas Caprae
	* A multi horned multi legged goat
		...
		+ but like multi legged as in more than 4? maybe it's also centaurish? or maybe it has a large body with 6 legs or smth
...
* Monstrum Pacificum Chimaera
	...
	* "A class of animal that Pigs, Cows, and Sheep all seeming come from; and the common food for the [[Lore|Starlight Powers]] to enjoy. Known for doing nothing but gorging itself."
	...
	+ also! since this is a class of animal, the deity is then the king of all of them. it has greater agency over the other chimeras, but also over the three animals that make it up.
...
* Dominus Harmonia
	...
	* "The most humanoid-appearing [[Lore|Starlight Powers]]. It's said to have been two older [[Lore|Starlight Powers]] that merged into one being - representing both the world's endless ability to create, and the conversing power to wipe the lands clear."
* Draco Spiritus
...
* Gladius et Defensio
	* A sword crossed over a shield
		...
		+ the premise/domain is good though!  
		+ Illagers! of course! (name will need changed)
	* Known for war and death
	* "The epitome of the Illager's ire. It is said to have provoked the Putridum Custodem [[Lore|Starlight Power]] into a brutish war with the other [[Lore|Starlight Powers]]."
	[[TODO|TODO: lengthen this description a bit, and change the deity's name]]
* Sensatus Spaerae
	* An orb with books floating around it
		+ still, a great premise, but I'm against animated objects as gods
		+ a great alternative would be allay-like
		+ -> A greater allay with books floating around it
...
* Comminui Cunicularius
	...
	* "A appallingly large being that is said to burrow its way into the world, leaving behind great caves and mountains. This burrowing has pastly disrupted the other [[Lore|Starlight Powers]] by bringing ruin to their kingdoms and lands. Though, this [[Lore|Starlight Power]] has little to no malice - it just endlessly digs."
* Infintia Natrurae
	* A tree-ent like being with both fire and leaves sprouting from their head
	* Known for life and punishments
	* "Other [[Lore|Starlight Power]] are fearful of Infintia Natrurae. A being that is both made of brimstone and wood, it is often seen as the one who made both the Overworld and Underworld as reflections of itself. It sees all life it has created as like its own children - but as well, when they do not act as it wishes, it punishes them dearly. For example, the piglins of the Nether are said to have once revolted against it."
